<template>
  <svg class="healthbar" :width="pixelSize * 16 * 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 25 9" shape-rendering="crispEdges">
